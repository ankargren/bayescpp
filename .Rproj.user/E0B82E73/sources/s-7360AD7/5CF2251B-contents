#ifndef BAYESCPP_MVN_H
#define BAYESCPP_MVN_H
inline arma::vec sample_normal_bcm(const arma::mat & Phi, const arma::vec & d, 
...
inline arma::vec sample_normal_rue(const arma::mat & Phi, const arma::vec & d, 
                         const arma::vec & alpha) {
